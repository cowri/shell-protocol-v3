...
import "../../adapters/PendleYTAdapter.sol";

contract TestPendleYTAdapter is Test {
    Ocean ocean;
    ...
    address secondaryTokenWallet = 0xc375Acaa2F0c5Bd351f7E53cFfE83c75333cD1D3;

    PendleYTAdapter adapter;

    address ezEth = 0x2416092f143378750bb29b79eD961ab195CcEea5;
    address ytEzEth = 0x05735B65686635F5C87AA9D2dae494Fb2E838f38;

    function setUp() public {
        vm.createSelectFork("https://arb1.arbitrum.io/rpc"); // Will start on latest block by default
        ocean = new Ocean("");
        adapter = new PendleYTAdapter(address(ocean), 0x60712e3C9136CF411C561b4E948d4d26637561e7, ezEth, router);
    }
    ...
    function testSwap(bool toggle, uint256 amount, uint256 unwrapFee) public {
        ...
        if (toggle) {
            user = wallet;
            inputAddress = ezEth;
            outputAddress = ytEzEth;
        } else {
            user = secondaryTokenWallet;
            inputAddress = ytEzEth;
            outputAddress = ezEth;
        }
