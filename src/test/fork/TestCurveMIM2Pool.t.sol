...
contract TestCurveMIM2Pool is Test {
    Ocean ocean;
    address wallet = 0x7B7B957c284C2C227C980d6E2F804311947b84d0; // MIM whale
    address secondaryTokenWallet = 0x641D99580f6cf034e1734287A9E8DaE4356641cA; // 2pool LP whale
    address lpWallet = 0xE5656D9cF64FF41CEb7e26E819D70df8B66d1595; // lp whale
    Curve2PoolAdapter adapter;
    address mim = 0xFEa7a6a0B346362BF88A9e4A88416B77a57D6c2A;
    address twoPoolLpToken = 0x7f90122BF0700F9E7e1F688fe926940E8839F353;

    function setUp() public {
        vm.createSelectFork("https://arb1.arbitrum.io/rpc"); // Will start on latest block by default
        ocean = new Ocean("");
        adapter = new Curve2PoolAdapter(address(ocean), 0x30dF229cefa463e991e29D42DB0bae2e122B2AC7); // mim pool address
    }
    ...
    function testSwap(bool toggle, uint256 amount, uint256 unwrapFee) public {
        ...
        if (toggle) {
            user = wallet;
            inputAddress = mim;
            outputAddress = twoPoolLpToken;
        } else {
            user = secondaryTokenWallet;
            inputAddress = twoPoolLpToken;
            outputAddress = mim;
        }
