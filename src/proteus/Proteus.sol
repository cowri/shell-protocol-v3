...
contract Proteus is ILiquidityPoolImplementation, Slices {
    ...
    constructor(int128[] memory ms, int128[] memory _as, int128[] memory bs, int128[] memory ks, uint256 _fee) Slices(ms, _as, bs, ks) {
    ...
    function depositGivenInputAmount(uint256 xBalance, uint256 yBalance, uint256 totalSupply, uint256 depositedAmount, SpecifiedToken depositedToken) external view returns (uint256 mintedAmount) {
        ...
        int256 result = _reserveTokenSpecified(depositedToken, int256(depositedAmount), FEE_DOWN, int256(totalSupply), int256(xBalance), int256(yBalance));
        require(result > 0);
    ...
    function depositGivenOutputAmount(uint256 xBalance, uint256 yBalance, uint256 totalSupply, uint256 mintedAmount, SpecifiedToken depositedToken) external view returns (uint256 depositedAmount) {
        ...
        int256 result = _lpTokenSpecified(depositedToken, int256(mintedAmount), FEE_UP, int256(totalSupply), int256(xBalance), int256(yBalance));
        require(result > 0);
    ...
    function withdrawGivenOutputAmount(uint256 xBalance, uint256 yBalance, uint256 totalSupply, uint256 withdrawnAmount, SpecifiedToken withdrawnToken) external view returns (uint256 burnedAmount) {
        ...
        int256 result = _reserveTokenSpecified(withdrawnToken, -int256(withdrawnAmount), FEE_UP, int256(totalSupply), int256(xBalance), int256(yBalance));
        require(result < 0);
    ...
    function withdrawGivenInputAmount(uint256 xBalance, uint256 yBalance, uint256 totalSupply, uint256 burnedAmount, SpecifiedToken withdrawnToken) external view returns (uint256 withdrawnAmount) {
        ...
        int256 result = _lpTokenSpecified(withdrawnToken, -int256(burnedAmount), FEE_DOWN, int256(totalSupply), int256(xBalance), int256(yBalance));
        require(result < 0);
     ...
     */
    function _swap(bool feeDirection, int256 specifiedAmount, int256 xi, int256 yi, SpecifiedToken specifiedToken) internal view returns (int256 computedAmount) {
        ...
        int256 yf;
        {
            ...
            if (specifiedToken == SpecifiedToken.X) {
                ...
                (xf, yf) = _findFinalPoint(fixedPoint, direction, utility, i, _getPointGivenXandUtility, slopes, _as, bs, ks);
            } else {
                int256 fixedPoint = yi + roundedSpecifiedAmount;
                int256 direction = (roundedSpecifiedAmount < 0) ? int256(-1) : int256(1);
                (xf, yf) = _findFinalPoint(fixedPoint, direction, utility, i, _getPointGivenYandUtility, slopes, _as, bs, ks);
            }
        }
     ...
     */
    function _reserveTokenSpecified(SpecifiedToken specifiedToken, int256 specifiedAmount, bool feeDirection, int256 si, int256 xi, int256 yi) internal view returns (int256 computedAmount) {
        int256 xf;
        int256 yf;
        int256 ui;
        int256 uf;
     ...
     *  and other variables declared in this scope.
     */
    function _lpTokenSpecified(SpecifiedToken specifiedToken, int256 specifiedAmount, bool feeDirection, int256 si, int256 xi, int256 yi) internal view returns (int256 computedAmount) {
        int128[] memory slopes = getSlopes();
        int128[] memory _as = getAs();
        int128[] memory bs = getBs();
        int128[] memory ks = getKs();

        (int256 uf, uint256 i) = _getUtilityFinalLp(si, si + _applyFeeByRounding(specifiedAmount, feeDirection), xi, yi, slopes, _as, bs, ks);
    ...
    function _getUtilityFinalLp(int256 si, int256 sf, int256 xi, int256 yi, int128[] memory slopes, int128[] memory _as, int128[] memory bs, int128[] memory ks) internal pure returns (int256 uf, uint256 i) {
     ...
     */
    function _getPointGivenXandUtility(int256 x, int256 utility, int128 a, int128 b, int128 k) internal pure returns (int256 xf, int256 yf) {
        xf = x;
     ...
     *  without caring about which particular function is was called.
     */
    function _getPointGivenYandUtility(int256 y, int256 utility, int128 a, int128 b, int128 k) internal pure returns (int256 xf, int256 yf) {
        yf = y;
        int256 ku = k.muli(utility);
     ...
     */
    function _pointIsNotInSlice(int128[] memory slopes, uint256 currentSlice, int256 x, int256 y) internal pure returns (bool inSlice) {
     ...
     */
    function _getSliceBoundaries(int128[] memory slopes, uint256 index) internal pure returns (int128 mLeft, int128 mRight) {
