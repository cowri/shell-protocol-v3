...
contract ConstantSum is LiquidityPool {
     ...
     */
    function depositGivenInputAmount(uint256, uint256 depositAmount) public pure override returns (uint256 mintAmount) {
        mintAmount = depositAmount;
    }

    function withdrawGivenInputAmount(uint256, uint256 burnAmount) public pure override returns (uint256 withdrawnAmount) {
    ...
    function depositGivenOutputAmount(uint256, uint256 mintAmount) public pure override returns (uint256 depositAmount) {
        depositAmount = mintAmount;
    }

    function withdrawGivenOutputAmount(uint256, uint256 withdrawnAmount) public pure override returns (uint256 burnAmount) {
